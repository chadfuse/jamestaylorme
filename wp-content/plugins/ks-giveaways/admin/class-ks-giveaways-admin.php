...
class KS_Giveaways_Admin
{
    ...
    public function admin_menu()
    {
        ...
        global $submenu;
        add_submenu_page('edit.php?post_type=' . KS_GIVEAWAYS_POST_TYPE, 'KingSumo Giveaways', 'Options', 'manage_options', 'ks-giveaways-options', array($this, 'settings_page'));
        $submenu['edit.php?post_type=' . KS_GIVEAWAYS_POST_TYPE][11][2] = 'options-general.php?page=ks-giveaways-options';
    }
